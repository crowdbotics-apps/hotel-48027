"""
Django settings for hotel_48027 project.
...
WSGI_APPLICATION = 'hotel_48027.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hotel_48027 API",
    "DESCRIPTION": "API documentation for hotel_48027 App",
    "VERSION": "v1",
}
